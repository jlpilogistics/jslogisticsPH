        ...
        <div class="col-md-8 offset-2">
            <div class="card">
                <div class="card-header">
                    <h3 style="text-align: center;color: #0b0c0f">Client Billing Management Import</h3>
                    <br>
                </div>
                            ...
                            <table class="table table-bordered mb-0">
                                ...
                                @foreach($char as $charge)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="icheck1">
                                                <input type="checkbox" name="bi[bi][]" id="input-2" value="{{$charge->particulars}}" >
                                                <input type="hidden" name="price[price][]" value="{{$charge->air}}">
                                            </div>
                                        </td>

                                        <td>
                                            <div class="icheck1">
                                                <input type="checkbox" name="soa[soa][]" id="input-2" value="{{$charge->particulars}}{{$charge->fcl20}}" >
